...
from visutils.video import create_video_input_stream
import cv2
...
if __name__ == '__main__':
    ...
    # st = create_video_input_stream('https://www.youtube.com/watch?v=FeJKJ5MoCHY')
    st = create_video_input_stream()
